...
export declare type SolitoImageProps = Pick<NextImageProps, AccessibilityProp<keyof NextImageProps> | 'alt' | 'blurDataURL' | 'placeholder' | 'loader' | 'priority' | 'loading' | 'sizes' | 'quality' | 'crossOrigin' | 'referrerPolicy' | 'quality' | 'unoptimized'> & {
    style?: ImageStyle;
} & ({
    src: string;
    height: number;
