...
export declare function LmRichTextRhf<T extends FieldValues>({ name, control, rules, defaultValue, ...inputProps }: LmRichTextRhfProps<T>): import("react/jsx-runtime").JSX.Element;
