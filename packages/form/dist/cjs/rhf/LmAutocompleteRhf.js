...
var import_react_hook_form = require("react-hook-form"), import_LmAutocomplete = require("../LmAutocomplete"), import_jsx_runtime = require("react/jsx-runtime");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_react_hook_form.Controller,
    {
      ...
      render: ({ field: { onChange, value }, fieldState: { error } }) => {
        ...
        return matchId && (currentValue = multiple ? (value || []).map((i) => options.find((j) => (j.value || j) === i)) : options.find((i) => (i.value || i) === value) || null), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
