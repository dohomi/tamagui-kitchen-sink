...
export declare function LmAutocompleteRhf<T extends FieldValues = FieldValues>({ name, rules, control, defaultValue, matchId, options, multiple, ...inputProps }: LmAutocompleteRhfProps<T>): import("react/jsx-runtime").JSX.Element;
