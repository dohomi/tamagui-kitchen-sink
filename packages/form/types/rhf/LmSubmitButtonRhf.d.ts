...
export declare function LmSubmitButtonRhf<TFieldValues extends FieldValues = FieldValues>({ onSubmit, ...props }: LmButtonRhfProps<TFieldValues>): import("react/jsx-runtime").JSX.Element;
