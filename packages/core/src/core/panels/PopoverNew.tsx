...
>(function PopoverAnchor(props: ScopedPopoverProps<PopoverAnchorProps>, forwardedRef) {
  ...
  return (
    <PopperAnchor __scopePopper={__scopePopover || POPOVER_SCOPE} {...rest} ref={forwardedRef} />
  )
})
...
>(function PopoverTrigger(props: ScopedPopoverProps<PopoverTriggerProps>, forwardedRef) {
  ...
  if (anchorTo) {
    ...
    return <PopperAnchor virtualRef={virtualRef} __scopePopper={__scopePopover || POPOVER_SCOPE} />
  }
...
export const PopoverContent: PopoverContentType = PopperContentFrame.extractable(
  React.forwardRef<PopoverContentTypeElement, ScopedPopoverProps<PopoverContentTypeProps>>(
    function PopoverContent(props: ScopedPopoverProps<PopoverContentTypeProps>, forwardedRef) {
      const {
        allowPinchZoom,
        trapFocus,
...
function PopoverContentPortal(
  props: Omit<ScopedPopoverProps<PopoverContentTypeProps>, 'setIsFullyHidden'>
) {
